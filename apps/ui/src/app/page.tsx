...
const Button = ({ url, src }: { url: string; src: string }) => (
  <a
    href={url}
    className="relative shrink-0 size-17 bg-white/20 backdrop-blur-md shadow-2xl rounded-2xl"
  >
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            >
              <svg
                ...
                className="size-4"
              >
                <path d="M5.055 7.06C3.805 6.347 2.25 7.25 2.25 8.69v6.622c0 1.44 1.555 2.343 2.805 1.628L12 12.872v2.34c0 1.44 1.555 2.343 2.805 1.628l7.108-4.061c1.26-.72 1.26-2.536 0-3.256l-7.108-4.061C13.555 4.715 12 5.618 12 7.058v2.34L5.055 5.44Z" />
              </svg>
            </button>
          </div>
        </Something>
